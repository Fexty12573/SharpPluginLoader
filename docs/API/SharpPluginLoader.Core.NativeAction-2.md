...
```csharp
public struct NativeAction<T1, T2>
```
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/System.Object) → [ValueType](https://docs.microsoft.com/en-us/dotnet/api/System.ValueType) → [NativeAction&lt;T1, T2&gt;](./SharpPluginLoader.Core.NativeAction-2.md)
