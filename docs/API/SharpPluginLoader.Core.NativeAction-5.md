...
```csharp
public struct NativeAction<T1, T2, T3, T4, T5>
```
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/System.Object) → [ValueType](https://docs.microsoft.com/en-us/dotnet/api/System.ValueType) → [NativeAction&lt;T1, T2, T3, T4, T5&gt;](./SharpPluginLoader.Core.NativeAction-5.md)
