...
```csharp
public struct NativeAction<T1, T2, T3, T4, T5, T6, T7, T8, T9>
```
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/System.Object) → [ValueType](https://docs.microsoft.com/en-us/dotnet/api/System.ValueType) → [NativeAction&lt;T1, T2, T3, T4, T5, T6, T7, T8, T9&gt;](./SharpPluginLoader.Core.NativeAction-9.md)
