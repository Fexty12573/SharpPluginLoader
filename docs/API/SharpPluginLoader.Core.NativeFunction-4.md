...
```csharp
public struct NativeFunction<T1, T2, T3, TRet>
```
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/System.Object) → [ValueType](https://docs.microsoft.com/en-us/dotnet/api/System.ValueType) → [NativeFunction&lt;T1, T2, T3, TRet&gt;](./SharpPluginLoader.Core.NativeFunction-4.md)
