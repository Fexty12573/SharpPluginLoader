...
```csharp
public struct NativeFunction<T1, T2, T3, T4, T5, T6, TRet>
```
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/System.Object) → [ValueType](https://docs.microsoft.com/en-us/dotnet/api/System.ValueType) → [NativeFunction&lt;T1, T2, T3, T4, T5, T6, TRet&gt;](./SharpPluginLoader.Core.NativeFunction-7.md)
