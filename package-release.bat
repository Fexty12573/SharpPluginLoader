...
set PLUGINS_DIR=%SOLUTION_DIR%\release-files\%CONFIGURATION%\nativePC\plugins
set LOADER_DIR=%PLUGINS_DIR%\CSharp\Loader

if "%CONFIGURATION%" == "Debug" (
    xcopy /Y /-I "%SOLUTION_DIR%\dependencies\cimgui\%CONFIGURATION%\cimgui.dll" "%LOADER_DIR%\cimgui.dll"
    ...
    xcopy /Y /-I "%SOLUTION_DIR%\x64\Debug\mhw-cs-plugin-loader.dll" "%PLUGINS_DIR%\SharpPluginLoader.Native.Debug.dll"
    ...
    xcopy /Y /-I "%SOLUTION_DIR%\x64\Release\mhw-cs-plugin-loader.dll" "%PLUGINS_DIR%\SharpPluginLoader.Native.dll"
    xcopy /Y /-I "%SOLUTION_DIR%\mhw-cs-plugin-loader\SharpPluginLoader.runtimeconfig.json" "%PLUGINS_DIR%\SharpPluginLoader.runtimeconfig.json"
)
